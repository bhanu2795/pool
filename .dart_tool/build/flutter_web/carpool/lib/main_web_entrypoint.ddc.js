define(['dart_sdk', 'packages/carpool/main'], function(dart_sdk, packages__carpool__main) {
  'use strict';
  ...
  const main = packages__carpool__main.main;
  ...
  dart.trackLibraries("packages/carpool/main_web_entrypoint", {
    "package:carpool/main_web_entrypoint.dart": main_web_entrypoint
  }, {
