...
let modulePaths = {
 ...
 "packages/carpool/main": "packages/carpool/main.ddc",
 "packages/carpool/main_web_entrypoint": "packages/carpool/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/carpool/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:carpool/main_web_entrypoint.dart") {
          // Clear static caches.
